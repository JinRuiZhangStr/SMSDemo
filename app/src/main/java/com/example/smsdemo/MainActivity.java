...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    private EditText phone,cord;
    private Button getCord,btn_login;
    ...
    private void initView() {
        phone= (EditText) findViewById(R.id.sEdit_phone);
        cord= (EditText) findViewById(R.id.sEdit_number);
        getCord= (Button) findViewById(R.id.sBtn);
        btn_login= (Button) findViewById(R.id.sBtn_login);
